...
class Panel:
    ...
    def wirte_words(self):
        ...
        pygame.draw.rect(self.screen,(0,0,255),(self.right+45, self.top+145, self.text_surface_restart.get_width()+10, self.text_surface_restart.get_height()+10))
